...
public class RoundTripRoutingTemplateTest {
    ...
    public void lookup_throwsIfNumberOfGivenPointsNotOne() {
        ...
        routingTemplate.lookup(Arrays.asList(ghPoint1, ghPoint2), carFE, null);
    }
    ...
    public void lookup_throwsIfNumberOfPointsInRequestNotOne() {
        ...
        routingTemplate.lookup(Collections.singletonList(ghPoint1), carFE, null);
    }
    ...
    public void testLookupAndCalcPaths_simpleSquareGraph() {
        ...
        List<QueryResult> stagePoints = routingTemplate.lookup(ghRequest.getPoints(), carFE, null);
